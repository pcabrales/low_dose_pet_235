...
PRETRAINED_MODEL_100DRF = os.path.join(MODEL_DIR, "nnformer_20251104_1349_drf100.pt")
FILTERS_100DRF = [8, 16, 32, 64]
NUM_LAYERS_100DRF = len(FILTERS_100DRF)

PRETRAINED_MODEL_50DRF = os.path.join(MODEL_DIR, "nnformer_20251104_1349_drf100.pt")
FILTERS_50DRF = [8, 16, 32, 64]
NUM_LAYERS_50DRF = len(FILTERS_50DRF)

PRETRAINED_MODEL_20DRF = os.path.join(MODEL_DIR, "nnformer_20251104_1353_drf20.pt")
FILTERS_20DRF = [8, 16, 32, 64]
NUM_LAYERS_20DRF = len(FILTERS_20DRF)

PRETRAINED_MODEL_10DRF = os.path.join(MODEL_DIR, "nnformer_20251104_1355_drf10.pt")
FILTERS_10DRF = [8, 16, 32, 64]
NUM_LAYERS_10DRF = len(FILTERS_10DRF)


PRETRAINED_MODEL_4DRF = os.path.join(MODEL_DIR, "nnformer_20251104_2151_drf4.pt")
