...
PRETRAINED_MODEL_100DRF = os.path.join(MODEL_DIR, ".pt")
FILTERS_100DRF = [8, 16, 32, 64]
NUM_LAYERS_100DRF = len(FILTERS_100DRF)

PRETRAINED_MODEL_50DRF = os.path.join(MODEL_DIR, ".pt")
FILTERS_50DRF = [8, 16, 32, 64]
NUM_LAYERS_50DRF = len(FILTERS_50DRF)

PRETRAINED_MODEL_20DRF = os.path.join(MODEL_DIR, ".pt")
...
PRETRAINED_MODEL_4DRF = os.path.join(MODEL_DIR, ".pt")
