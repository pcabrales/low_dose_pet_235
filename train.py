...
PRETRAINED_MODEL_100DRF = os.path.join(MODEL_DIR, "nnformer_20251104_1107_drf100.pt")
FILTERS_100DRF = [8, 16, 32, 64]
NUM_LAYERS_100DRF = len(FILTERS_100DRF)

PRETRAINED_MODEL_50DRF = os.path.join(MODEL_DIR, "nnformer_20251104_1103_drf50_epoch022.pt")
FILTERS_50DRF = [8, 16, 32, 64]
NUM_LAYERS_50DRF = len(FILTERS_50DRF)

PRETRAINED_MODEL_20DRF = os.path.join(MODEL_DIR, "nnformer_20251104_2059_drf20_epoch018.pt")
FILTERS_20DRF = [8, 16, 32, 64]
NUM_LAYERS_20DRF = len(FILTERS_20DRF)

PRETRAINED_MODEL_10DRF = os.path.join(MODEL_DIR,  "nnformer_20251105_0201_drf10_epoch018.pt")
FILTERS_10DRF = [8, 16, 32, 64]
NUM_LAYERS_10DRF = len(FILTERS_10DRF)

PRETRAINED_MODEL_4DRF = os.path.join(MODEL_DIR, "nnformer_20251104_1857_drf4_epoch018.pt")
FILTERS_4DRF = [8, 16, 32, 64]
NUM_LAYERS_4DRF = len(FILTERS_4DRF)
